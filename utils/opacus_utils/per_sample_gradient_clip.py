...
class PerSampleGradientClipper:
    ...
    def _weighted_sum(
        ...
        # print(f"Tensor 'batch_weight' shape: {batch_weight.shape}")
        # print(f"Tensor 'param' shape: {param.shape}")

        clipped_batch_weight = batch_weight[:param.shape[0]]
        return torch.einsum("i,i...", clipped_batch_weight, param)
