...
class TrainLoop:
    def __init__(self, args, train_platform, model, diffusion, data):
        ...
        self.privacy_engine = PrivacyEngine(self.model, args.batch_size, len(self.data.dataset), [10, 100], 1.75, 1.0)
        self.privacy_engine.attach(self.opt)
    ...
    def save(self):
        ...
        print(f"Privacy spent (Epsilon, Delta): {self.privacy_engine.get_privacy_spent()}")
